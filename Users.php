...
class Users{
  ...
  public function userRegistration($data){
    ...
    if ($name == "" || $username == "" || $email == "" || $mobile == "" || $password == "") {
      $msg = '<div class="alert alert-danger alert-dismissible mt-0" id="flash-msg" style="margin:0 auto;>
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Please, User Registration field must not be Empty !</div>';
        return $msg;
    }elseif (strlen($username) < 3) {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg style="margin:0 auto;">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $result = $stmt->execute();
      if ($result) {
        $msg = '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg style="margin:0 auto;">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
//toll booth
  ...
  <strong>Error !</strong> Email did not Found, use Register email or password please !</div>';
    ...
    <strong>Error !</strong> Sorry, Your account is Diactivated, Contact with Admin !</div>';
          ...
          Session::set('logMsg', '<div class="alert alert-success alert-dismissible" id="flash-msg" style="margin:0 auto; ">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  <strong>Error !</strong> Invalid email address !</div>';
        ...
        if ($result) {
          echo "<script>location.href='index2.php';</script>";
          Session::set('msg', '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg" style="margin:0 auto;">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          ...
          echo "<script>location.href='index2.php';</script>";
          Session::set('msg', '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg" style="margin:0 auto;">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
